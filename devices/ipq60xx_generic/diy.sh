...
rm -rf package/boot/uboot-envtools package/kernel package/firmware/ath11k* package/qca target/linux/generic target/linux/ipq60xx package/network/config/netifd feeds/womade/fullconenat toolchain
...
rm -rf feeds/packages/net/openvswitch feeds/womade/shortcut-fe feeds/packages/net/xtables-addons package/kernel/mt76
